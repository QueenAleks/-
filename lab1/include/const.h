...
// len = 64
const std::vector<uint8_t> initialPermutation = {
...
// len = 64
const std::vector<uint8_t> finalPermutation = {
...
// bits.
// len = 48
const std::vector<uint8_t> expansionFunction = {
...
// len = 32
const std::vector<uint8_t> permutationFunction = {
...
// from a 64-bit input.
// len = 56
const std::vector<uint8_t> permutedChoice1 = {
...
// the 56-bit input
// len = 48
const std::vector<uint8_t> permutedChoice2 = {
...
const uint8_t ksRotations[16] = {1, 1, 2, 2, 2, 2, 2, 2,
                                 1, 2, 2, 2, 2, 2, 2, 1};
